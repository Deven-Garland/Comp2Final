...
if __name__ == "__main__":
    ...
    # Add items
    print("Adding items...")
    sword = Weapon("Iron Sword", "A sturdy blade", graphics_path("test", "rock.png"), attack_bonus=10, value=100)
    inventory.add_item(sword)
    
    armor = Armor("Leather Armor", "Light protection", graphics_path("test", "rock.png"), defense_bonus=5, value=80)
    inventory.add_item(armor)
    
    potion1 = Consumable("Health Potion", "Heals 50 HP", graphics_path("test", "rock.png"),
                        effect_type="heal", effect_amount=50, value=25)
    inventory.add_item(potion1)
    
    potion2 = Consumable("Health Potion", "Heals 50 HP", graphics_path("test", "rock.png"),
                        effect_type="heal", effect_amount=50, value=25)
    potion2.quantity = 3
